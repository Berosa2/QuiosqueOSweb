...
gdjs.inicialCode.GDTextoObjects3= [];
gdjs.inicialCode.GDimgObjects1= [];
gdjs.inicialCode.GDimgObjects2= [];
gdjs.inicialCode.GDimgObjects3= [];
gdjs.inicialCode.GDlinkObjects1= [];
gdjs.inicialCode.GDlinkObjects2= [];
gdjs.inicialCode.GDlinkObjects3= [];
gdjs.inicialCode.GDimg2Objects1= [];
gdjs.inicialCode.GDimg2Objects2= [];
gdjs.inicialCode.GDimg2Objects3= [];
gdjs.inicialCode.GDTexto2Objects1= [];
gdjs.inicialCode.GDTexto2Objects2= [];
gdjs.inicialCode.GDTexto2Objects3= [];
gdjs.inicialCode.GDlink2Objects1= [];
gdjs.inicialCode.GDlink2Objects2= [];
gdjs.inicialCode.GDlink2Objects3= [];
gdjs.inicialCode.GDcompartilharObjects1= [];
gdjs.inicialCode.GDcompartilharObjects2= [];
gdjs.inicialCode.GDcompartilharObjects3= [];
gdjs.inicialCode.GDNewTextObjects1= [];
gdjs.inicialCode.GDNewTextObjects2= [];
gdjs.inicialCode.GDNewTextObjects3= [];
gdjs.inicialCode.GDborder3Objects1= [];
gdjs.inicialCode.GDborder3Objects2= [];
gdjs.inicialCode.GDborder3Objects3= [];
gdjs.inicialCode.GDNewSprite2Objects1= [];
gdjs.inicialCode.GDNewSprite2Objects2= [];
gdjs.inicialCode.GDNewSprite2Objects3= [];
gdjs.inicialCode.GDStObjects1= [];
gdjs.inicialCode.GDStObjects2= [];
gdjs.inicialCode.GDStObjects3= [];
gdjs.inicialCode.GDNewSprite3Objects1= [];
gdjs.inicialCode.GDNewSprite3Objects2= [];
gdjs.inicialCode.GDNewSprite3Objects3= [];
gdjs.inicialCode.GDIcone_9595configura_95231_95227oObjects1= [];
gdjs.inicialCode.GDIcone_9595configura_95231_95227oObjects2= [];
gdjs.inicialCode.GDIcone_9595configura_95231_95227oObjects3= [];
gdjs.inicialCode.GDborderObjects1= [];
gdjs.inicialCode.GDborderObjects2= [];
gdjs.inicialCode.GDborderObjects3= [];
gdjs.inicialCode.GDborder2Objects1= [];
gdjs.inicialCode.GDborder2Objects2= [];
gdjs.inicialCode.GDborder2Objects3= [];
gdjs.inicialCode.GDbuttonPlaceObjects1= [];
gdjs.inicialCode.GDbuttonPlaceObjects2= [];
gdjs.inicialCode.GDbuttonPlaceObjects3= [];
gdjs.inicialCode.GDGreyButtonWithShadow3Objects1= [];
gdjs.inicialCode.GDGreyButtonWithShadow3Objects2= [];
gdjs.inicialCode.GDGreyButtonWithShadow3Objects3= [];
gdjs.inicialCode.GDbuttonPlace2Objects1= [];
gdjs.inicialCode.GDbuttonPlace2Objects2= [];
gdjs.inicialCode.GDbuttonPlace2Objects3= [];


gdjs.inicialCode.asyncCallback17016972 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(4), (runtimeScene) => (gdjs.inicialCode.asyncCallback17016972(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.inicialCode.asyncCallback17022860 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.inicialCode.localVariables);
gdjs.inicialCode.localVariables.length = 0;
}
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.inicialCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__Share__Share.func(runtimeScene, "Veja esse Quiosque, id dele é " + runtimeScene.getGame().getVariables().getFromIndex(0).getAsString(), "", "Me ajude no Projeto compartilhando ele.", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)), (runtimeScene) => (gdjs.inicialCode.asyncCallback17022860(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.inicialCode.eventsList2 = function(runtimeScene) {
...
};gdjs.inicialCode.eventsList3 = function(runtimeScene) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.inicialCode.GDimgObjects2.length;i<l;++i) {
    if ( gdjs.inicialCode.GDimgObjects2[i].getBehavior("ButtonFSM").IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.inicialCode.GDimgObjects2[k] = gdjs.inicialCode.GDimgObjects2[i];
        ++k;
    }
}
gdjs.inicialCode.GDimgObjects2.length = k;
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
};gdjs.inicialCode.eventsList4 = function(runtimeScene) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.inicialCode.GDimg2Objects2.length;i<l;++i) {
    if ( gdjs.inicialCode.GDimg2Objects2[i].getBehavior("ButtonFSM").IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.inicialCode.GDimg2Objects2[k] = gdjs.inicialCode.GDimg2Objects2[i];
        ++k;
    }
}
gdjs.inicialCode.GDimg2Objects2.length = k;
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
};gdjs.inicialCode.eventsList5 = function(runtimeScene) {
...
}{for(var i = 0, len = gdjs.inicialCode.GDimgObjects1.length ;i < len;++i) {
    gdjs.inicialCode.GDimgObjects1[i].setPosition(runtimeScene.getScene().getVariables().getFromIndex(10).getAsNumber(),runtimeScene.getScene().getVariables().getFromIndex(11).getAsNumber());
}
}{for(var i = 0, len = gdjs.inicialCode.GDimg2Objects1.length ;i < len;++i) {
    gdjs.inicialCode.GDimg2Objects1[i].setPosition(runtimeScene.getScene().getVariables().getFromIndex(12).getAsNumber(),runtimeScene.getScene().getVariables().getFromIndex(13).getAsNumber());
}
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__RepeatEveryXSeconds__Repeat.func(runtimeScene, "GenerateIMG", 1, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("img"), gdjs.inicialCode.GDimgObjects1);
gdjs.copyArray(runtimeScene.getObjects("img2"), gdjs.inicialCode.GDimg2Objects1);
{gdjs.evtsExt__LoadImageFromURL__LoadURLIntoSprite.func(runtimeScene, runtimeScene.getScene().getVariables().getFromIndex(3).getAsString(), gdjs.inicialCode.mapOfGDgdjs_9546inicialCode_9546GDimg2Objects1Objects, true, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}{gdjs.evtsExt__LoadImageFromURL__LoadURLIntoSprite.func(runtimeScene, runtimeScene.getScene().getVariables().getFromIndex(2).getAsString(), gdjs.inicialCode.mapOfGDgdjs_9546inicialCode_9546GDimgObjects1Objects, true, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
...
gdjs.copyArray(runtimeScene.getObjects("compartilhar"), gdjs.inicialCode.GDcompartilharObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.inicialCode.GDcompartilharObjects1.length;i<l;++i) {
    if ( gdjs.inicialCode.GDcompartilharObjects1[i].getBehavior("ButtonFSM").IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.inicialCode.GDcompartilharObjects1[k] = gdjs.inicialCode.GDcompartilharObjects1[i];
        ++k;
    }
}
gdjs.inicialCode.GDcompartilharObjects1.length = k;
if (isConditionTrue_0) {

{ //Subevents
gdjs.inicialCode.eventsList1(runtimeScene);} //End of subevents
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17025276);
}
}
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.getField(runtimeScene.getGame().getVariables().getFromIndex(0).getAsString() + "-" + runtimeScene.getScene().getVariables().getFromIndex(16).getAsString(), "par1", runtimeScene.getScene().getVariables().getFromIndex(26), gdjs.VariablesContainer.badVariable);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17026732);
}
}
if (isConditionTrue_0) {
{gdjs.evtTools.firebaseTools.database.getField(runtimeScene.getGame().getVariables().getFromIndex(0).getAsString() + "-" + runtimeScene.getScene().getVariables().getFromIndex(17).getAsString(), "par1", runtimeScene.getScene().getVariables().getFromIndex(27), gdjs.VariablesContainer.badVariable);
}{gdjs.evtTools.firebaseTools.database.getField(runtimeScene.getGame().getVariables().getFromIndex(0).getAsString() + "-" + runtimeScene.getScene().getVariables().getFromIndex(17).getAsString(), "par2", runtimeScene.getScene().getVariables().getFromIndex(28), gdjs.VariablesContainer.badVariable);
}{gdjs.evtTools.firebaseTools.database.getField(runtimeScene.getGame().getVariables().getFromIndex(0).getAsString() + "-" + runtimeScene.getScene().getVariables().getFromIndex(17).getAsString(), "Tipo", runtimeScene.getScene().getVariables().getFromIndex(29), gdjs.VariablesContainer.badVariable);
}}
...
gdjs.inicialCode.eventsList2(runtimeScene);
}
...
gdjs.inicialCode.eventsList3(runtimeScene);
}
...
gdjs.inicialCode.eventsList4(runtimeScene);
}
...
gdjs.inicialCode.GDTextoObjects3.length = 0;
gdjs.inicialCode.GDimgObjects1.length = 0;
gdjs.inicialCode.GDimgObjects2.length = 0;
gdjs.inicialCode.GDimgObjects3.length = 0;
gdjs.inicialCode.GDlinkObjects1.length = 0;
gdjs.inicialCode.GDlinkObjects2.length = 0;
gdjs.inicialCode.GDlinkObjects3.length = 0;
gdjs.inicialCode.GDimg2Objects1.length = 0;
gdjs.inicialCode.GDimg2Objects2.length = 0;
gdjs.inicialCode.GDimg2Objects3.length = 0;
gdjs.inicialCode.GDTexto2Objects1.length = 0;
gdjs.inicialCode.GDTexto2Objects2.length = 0;
gdjs.inicialCode.GDTexto2Objects3.length = 0;
gdjs.inicialCode.GDlink2Objects1.length = 0;
gdjs.inicialCode.GDlink2Objects2.length = 0;
gdjs.inicialCode.GDlink2Objects3.length = 0;
gdjs.inicialCode.GDcompartilharObjects1.length = 0;
gdjs.inicialCode.GDcompartilharObjects2.length = 0;
gdjs.inicialCode.GDcompartilharObjects3.length = 0;
gdjs.inicialCode.GDNewTextObjects1.length = 0;
gdjs.inicialCode.GDNewTextObjects2.length = 0;
gdjs.inicialCode.GDNewTextObjects3.length = 0;
gdjs.inicialCode.GDborder3Objects1.length = 0;
gdjs.inicialCode.GDborder3Objects2.length = 0;
gdjs.inicialCode.GDborder3Objects3.length = 0;
gdjs.inicialCode.GDNewSprite2Objects1.length = 0;
gdjs.inicialCode.GDNewSprite2Objects2.length = 0;
gdjs.inicialCode.GDNewSprite2Objects3.length = 0;
gdjs.inicialCode.GDStObjects1.length = 0;
gdjs.inicialCode.GDStObjects2.length = 0;
gdjs.inicialCode.GDStObjects3.length = 0;
gdjs.inicialCode.GDNewSprite3Objects1.length = 0;
gdjs.inicialCode.GDNewSprite3Objects2.length = 0;
gdjs.inicialCode.GDNewSprite3Objects3.length = 0;
...
gdjs.inicialCode.GDIcone_9595configura_95231_95227oObjects3.length = 0;
gdjs.inicialCode.GDborderObjects1.length = 0;
gdjs.inicialCode.GDborderObjects2.length = 0;
gdjs.inicialCode.GDborderObjects3.length = 0;
gdjs.inicialCode.GDborder2Objects1.length = 0;
gdjs.inicialCode.GDborder2Objects2.length = 0;
gdjs.inicialCode.GDborder2Objects3.length = 0;
gdjs.inicialCode.GDbuttonPlaceObjects1.length = 0;
gdjs.inicialCode.GDbuttonPlaceObjects2.length = 0;
gdjs.inicialCode.GDbuttonPlaceObjects3.length = 0;
gdjs.inicialCode.GDGreyButtonWithShadow3Objects1.length = 0;
gdjs.inicialCode.GDGreyButtonWithShadow3Objects2.length = 0;
gdjs.inicialCode.GDGreyButtonWithShadow3Objects3.length = 0;
gdjs.inicialCode.GDbuttonPlace2Objects1.length = 0;
gdjs.inicialCode.GDbuttonPlace2Objects2.length = 0;
gdjs.inicialCode.GDbuttonPlace2Objects3.length = 0;

gdjs.inicialCode.eventsList5(runtimeScene);
gdjs.inicialCode.GDTextoObjects1.length = 0;
gdjs.inicialCode.GDTextoObjects2.length = 0;
gdjs.inicialCode.GDTextoObjects3.length = 0;
gdjs.inicialCode.GDimgObjects1.length = 0;
