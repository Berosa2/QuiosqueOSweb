...
gdjs.inicialCode.asyncCallback15585420 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__Share__Share.func(runtimeScene, "Veja esse Quiosque, id dele é " + runtimeScene.getGame().getVariables().getFromIndex(0).getAsString(), "", "Me ajude no Projeto compartilhando ele.", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)), (runtimeScene) => (gdjs.inicialCode.asyncCallback15585420(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("Texto"), gdjs.inicialCode.GDTextoObjects2);
{for(var i = 0, len = gdjs.inicialCode.GDTextoObjects2.length ;i < len;++i) {
    gdjs.inicialCode.GDTextoObjects2[i].getBehavior("Text").setText(runtimeScene.getScene().getVariables().getFromIndex(22).getAsString());
}
}{runtimeScene.getScene().getVariables().getFromIndex(19).setBoolean(false);
}}
...
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("Texto2"), gdjs.inicialCode.GDTexto2Objects2);
{for(var i = 0, len = gdjs.inicialCode.GDTexto2Objects2.length ;i < len;++i) {
    gdjs.inicialCode.GDTexto2Objects2[i].getBehavior("Text").setText(runtimeScene.getScene().getVariables().getFromIndex(22).getAsString());
}
}{runtimeScene.getScene().getVariables().getFromIndex(19).setBoolean(false);
}}
...
gdjs.copyArray(runtimeScene.getObjects("Texto2"), gdjs.inicialCode.GDTexto2Objects2);
{for(var i = 0, len = gdjs.inicialCode.GDTexto2Objects2.length ;i < len;++i) {
    gdjs.inicialCode.GDTexto2Objects2[i].getBehavior("Text").setText(runtimeScene.getScene().getVariables().getFromIndex(25).getAsString());
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("Texto"), gdjs.inicialCode.GDTextoObjects2);
{for(var i = 0, len = gdjs.inicialCode.GDTextoObjects2.length ;i < len;++i) {
    gdjs.inicialCode.GDTextoObjects2[i].getBehavior("Text").setText(runtimeScene.getScene().getVariables().getFromIndex(25).getAsString());
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("Texto2"), gdjs.inicialCode.GDTexto2Objects2);
{for(var i = 0, len = gdjs.inicialCode.GDTexto2Objects2.length ;i < len;++i) {
    gdjs.inicialCode.GDTexto2Objects2[i].getBehavior("Text").setText(runtimeScene.getScene().getVariables().getFromIndex(28).getAsString());
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("Texto"), gdjs.inicialCode.GDTextoObjects2);
{for(var i = 0, len = gdjs.inicialCode.GDTextoObjects2.length ;i < len;++i) {
    gdjs.inicialCode.GDTextoObjects2[i].getBehavior("Text").setText(runtimeScene.getScene().getVariables().getFromIndex(28).getAsString());
}
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15587836);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15589292);
}
}
if (isConditionTrue_0) {
