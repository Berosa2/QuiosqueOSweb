...
gdjs.StudioCode.asyncCallback17365316 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.StudioCode.asyncCallback17365316(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.StudioCode.asyncCallback15671748 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.StudioCode.localVariables);
gdjs.copyArray(asyncObjectsList.getObjects("QuiosqueIcon"), gdjs.StudioCode.GDQuiosqueIconObjects2);
...
asyncObjectsList.backupLocalVariablesContainers(gdjs.StudioCode.localVariables);
for (const obj of gdjs.StudioCode.GDQuiosqueIconObjects1) asyncObjectsList.addObject("QuiosqueIcon", obj);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.StudioCode.asyncCallback15671748(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.StudioCode.asyncCallback15670796 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.StudioCode.localVariables);
gdjs.copyArray(asyncObjectsList.getObjects("QuiosqueIcon"), gdjs.StudioCode.GDQuiosqueIconObjects2);
...
asyncObjectsList.backupLocalVariablesContainers(gdjs.StudioCode.localVariables);
for (const obj of gdjs.StudioCode.GDQuiosqueIconObjects1) asyncObjectsList.addObject("QuiosqueIcon", obj);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.StudioCode.asyncCallback15670796(runtimeScene, asyncObjectsList)));
}
}
...
for (var i = 0, k = 0, l = gdjs.StudioCode.GDChevron_9595Arrow_9595LeftObjects1.length;i<l;++i) {
    if ( gdjs.StudioCode.GDChevron_9595Arrow_9595LeftObjects1[i].getBehavior("ButtonFSM").IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
...
for (var i = 0, k = 0, l = gdjs.StudioCode.GDChevron_9595Arrow_9595RightObjects1.length;i<l;++i) {
    if ( gdjs.StudioCode.GDChevron_9595Arrow_9595RightObjects1[i].getBehavior("ButtonFSM").IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
...
for (var i = 0, k = 0, l = gdjs.StudioCode.GDFindObjects1.length;i<l;++i) {
    if ( gdjs.StudioCode.GDFindObjects1[i].getBehavior("ButtonFSM").IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
